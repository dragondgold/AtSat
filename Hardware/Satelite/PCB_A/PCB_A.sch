...
F2 "VBat+" O R 3450 2600 50 
F3 "VBUS" I R 3450 2850 50 
F4 "ISET" I R 3450 2950 50 
F5 "CHG" O R 3450 3050 50 
F6 "CHG_DISABLE" I R 3450 2750 50 
$EndSheet
$Comp
...
U 1 1 5BA1A8A6
P 6600 5450
F 0 "J3" H 6680 5492 50  0000 L CNN
F 1 "Servo Paracaídas" H 6680 5401 50  0000 L CNN
...
U 1 1 5BA1A8E2
P 5150 5450
F 0 "J1" H 5230 5492 50  0000 L CNN
F 1 "Servo Globo" H 5230 5401 50  0000 L CNN
...
U 1 1 5BA4343B
P 4600 4050
F 0 "U1" H 4600 4315 50  0000 C CNN
F 1 "CONUFL001-SMD" H 4600 4224 50  0000 C CNN
F 2 "" H 4600 4250 50  0001 C CNN
F 3 "https://componentsearchengine.com/Datasheets/1/CONUFL001-SMD.pdf" H 4600 4250 50  0001 C CNN
F 4 "CONUFL001-SMD" H 4700 4300 50  0001 C CNN "Manufacturer Part Number"
	1    4600 4050
	-1   0    0    -1  
$EndComp
Wire Wire Line
...
F 0 "#PWR014" H 8750 3650 50  0001 C CNN
...
F0 "CC1101" 50
F1 "CC1101.sch" 50
F2 "SDO" O R 3450 3600 50 
F3 "SDI" I R 3450 3700 50 
F4 "SCLK" O R 3450 3800 50 
F5 "ANT" B R 3450 4050 50 
$EndSheet
Wire Wire Line
	3450 2750 4200 2750
Wire Wire Line
...
U 1 1 5BAE15D7
P 5500 2600
F 0 "J2" H 5579 2592 50  0000 L CNN
F 1 "Batería LiPo" H 5579 2501 50  0000 L CNN
...
U 1 1 5BAE3EF9
P 4700 2900
F 0 "Q1" V 5267 3000 50  0000 C CNN
F 1 "SSM3J338R,LF" V 5176 3000 50  0000 C CNN
F 2 "SamacSys_Parts:SSM3J332RLFT" H 5150 2850 50  0001 L CNN
F 3 "http://toshiba.semicon-storage.com/info/docget.jsp?did=30384&prodName=SSM3J338R" H 5150 2750 50  0001 L CNN
F 4 "MOSFET Small-signal MOSFET Vdss= -12V, ID= -6A" H 5150 2650 50  0001 L CNN "Description"
F 5 "Toshiba" H 5150 2450 50  0001 L CNN "Manufacturer_Name"
F 6 "SSM3J338R,LF" H 5150 2350 50  0001 L CNN "Manufacturer Part Number"
F 7 "SSM3J338R,LF" H 5150 2050 50  0001 L CNN "Arrow Part Number"
F 8 "https://www.arrow.com/en/products/ssm3j338rlf/toshiba" H 5150 1950 50  0001 L CNN "Arrow Price/Stock"
	1    4700 2900
	0    1    -1   0   
$EndComp
Wire Wire Line
...
U 1 1 5BAE96AC
P 5250 5650
F 0 "#PWR03" H 5250 5400 50  0001 C CNN
...
U 1 1 5BAE9E59
P 6700 5650
F 0 "#PWR09" H 6700 5400 50  0001 C CNN
...
F 0 "#PWR06" H 5500 5600 50  0001 C CNN
...
F 0 "#PWR010" H 6950 5600 50  0001 C CNN
