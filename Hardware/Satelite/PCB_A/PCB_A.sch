...
U 1 1 5BAE15D7
P 5250 2600
F 0 "J2" H 5329 2592 50  0000 L CNN
F 1 "Batería LiPo" H 5329 2501 50  0000 L CNN
...
U 1 1 5BAE1DFC
P 5050 2900
F 0 "#PWR04" H 5050 2650 50  0001 C CNN
...
U 1 1 5BAE3EF9
P 4450 2900
F 0 "Q1" V 5017 3000 50  0000 C CNN
F 1 "SSM3J338R,LF" V 4926 3000 50  0000 C CNN
F 2 "SamacSys_Parts:SSM3J332RLFT" H 4900 2850 50  0001 L CNN
F 3 "http://toshiba.semicon-storage.com/info/docget.jsp?did=30384&prodName=SSM3J338R" H 4900 2750 50  0001 L CNN
F 4 "MOSFET Small-signal MOSFET Vdss= -12V, ID= -6A" H 4900 2650 50  0001 L CNN "Description"
F 5 "Toshiba" H 4900 2450 50  0001 L CNN "Manufacturer_Name"
F 6 "SSM3J338R,LF" H 4900 2350 50  0001 L CNN "Manufacturer Part Number"
F 7 "SSM3J338R,LF" H 4900 2050 50  0001 L CNN "Arrow Part Number"
F 8 "https://www.arrow.com/en/products/ssm3j338rlf/toshiba" H 4900 1950 50  0001 L CNN "Arrow Price/Stock"
	1    4450 2900
	0    1    -1   0   
$EndComp
Wire Wire Line
...
U 1 1 5BAF29A3
P 7400 1600
F 0 "D3" V 7345 1678 50  0000 L CNN
F 1 "LED" V 7436 1678 50  0000 L CNN
...
F 0 "R3" V 7500 1200 50  0000 L CNN
F 1 "1k" V 7300 1200 50  0000 L CNN
...
F 0 "C16" H 4200 2750 50  0000 L CNN
F 1 "1uF" H 4150 2650 50  0000 L CNN
...
Wire Wire Line
	4050 2850 4050 2900
Text HLabel 2400 1350 2    50   BiDi ~ 0
SYS
Wire Wire Line
	2400 1350 2300 1350
Wire Wire Line
...
SCL
Text HLabel 3050 1600 0    50   BiDi ~ 0
SDA
Text HLabel 3050 1700 0    50   Output ~ 0
GPOUT
Wire Wire Line
	3050 1500 3600 1500
Wire Wire Line
...
F2 "VSENSE" O R 4700 1350 50 
$EndSheet
Text HLabel 4050 1350 2    50   Output ~ 0
OUT
Wire Wire Line
	4050 1350 3050 1350
