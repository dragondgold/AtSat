...
F 0 "#PWR1" H 10300 6000 50  0001 C CNN
F 1 "+3V3_Internal" H 10285 5773 50  0000 C CNN
...
U 1 1 5BC1C484
P 9350 5750
F 0 "U1" H 9350 6067 50  0000 C CNN
F 1 "MIC5323-3.3YD5_TR" H 9350 5975 50  0000 C CNN
F 2 "SOT95P280X100-5N" H 10300 5850 50  0001 L CNN
F 3 "http://ww1.microchip.com/downloads/en/DeviceDoc/MIC5323.pdf" H 10300 5750 50  0001 L CNN
F 4 "Micrel MIC5323-3.3YD5 TR, LDO Voltage Regulator, 300mA, 3.3 V 2%, 2.65  5.5 Vin, 5-Pin TSOT-23" H 10300 5650 50  0001 L CNN "Description"
F 5 "1" H 10300 5550 50  0001 L CNN "Height"
F 6 "Micrel" H 10300 5450 50  0001 L CNN "Manufacturer_Name"
F 7 "MIC5323-3.3YD5 TR" H 10300 5350 50  0001 L CNN "Manufacturer Part Number"
F 8 "8855996P" H 10300 5250 50  0001 L CNN "RS Part Number"
F 9 "http://uk.rs-online.com/web/p/products/8855996P" H 10300 5150 50  0001 L CNN "RS Price/Stock"
F 10 "MIC5323-3.3YD5 TR" H 10300 5050 50  0001 L CNN "Arrow Part Number"
F 11 "http://uk.rs-online.com/web/p/products/8855996P" H 10300 4950 50  0001 L CNN "Arrow Price/Stock"
	1    9350 5750
	1    0    0    -1  
$EndComp
$Comp
...
F 0 "C3" H 8258 5954 50  0000 R CNN
...
U 1 1 5BC1CAF8
P 8350 5600
F 0 "#PWR0106" H 8350 5450 50  0001 C CNN
F 1 "+BATT" H 8364 5775 50  0000 C CNN
...
U 1 1 5BC1D4AF
P 8350 6200
F 0 "#PWR0107" H 8350 5950 50  0001 C CNN
F 1 "GND" H 8354 6026 50  0000 C CNN
...
U 1 1 5BC1E4A2
P 9350 6200
F 0 "#PWR0108" H 9350 5950 50  0001 C CNN
F 1 "GND" H 9354 6026 50  0000 C CNN
...
U 1 1 5BC1FF7A
P 10300 6200
F 0 "#PWR0109" H 10300 5950 50  0001 C CNN
F 1 "GND" H 10304 6026 50  0000 C CNN
...
F 0 "C4" H 9758 6004 50  0000 R CNN
...
U 1 1 5BC20E11
P 9850 6200
F 0 "#PWR0110" H 9850 5950 50  0001 C CNN
F 1 "GND" H 9854 6026 50  0000 C CNN
...
F 1 "+5V" H 10464 3725 50  0000 C CNN
...
Wire Wire Line
	10450 3650 9750 3650
$Comp
L power:+3V3 #PWR0113
U 1 1 5BD864D7
P 10600 3700
F 0 "#PWR0113" H 10600 3550 50  0001 C CNN
F 1 "+3V3" H 10614 3875 50  0000 C CNN
...
F 0 "#PWR3" H 10850 4350 50  0001 C CNN
F 1 "+3V3_Internal" H 10835 4123 50  0000 C CNN
...
$EndComp
Wire Wire Line
	9750 3950 10850 3950
$Comp
L power:+BATT #PWR0114
U 1 1 5BD9C81C
P 11000 4100
F 0 "#PWR0114" H 11000 3950 50  0001 C CNN
F 1 "+BATT" H 11014 4275 50  0000 C CNN
...
U 1 1 5BDD1CE4
P 10000 4600
F 0 "#PWR0115" H 10000 4350 50  0001 C CNN
F 1 "GND" H 10004 4426 50  0000 C CNN
...
U 1 1 5BD2AA01
P 9050 3450
F 0 "J1" H 9050 4167 50  0000 C CNN
F 1 "Conector_PCB_B-C" H 9050 4075 50  0000 C CNN
F 2 "AXTEC:Conector_PCB_B-C" H 8950 4200 50  0001 C CNN
...
U 1 1 5BDF4ABC
P 7800 3950
F 0 "#PWR0116" H 7800 3800 50  0001 C CNN
F 1 "VBUS" H 7814 4125 50  0000 C CNN
...
F 0 "C5" H 10208 6004 50  0000 R CNN
