...
#define CC1101_TX_BUFFER_SIZE   64
...
/**
 * @brief Check if a packet was sent (when sending packet) or received
 *  (when expecting a packet).
 * @return true packet was sent or a packet was received
 * @return false no packet sent or received
 */
