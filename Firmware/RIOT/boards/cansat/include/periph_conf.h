...
/**
 * @defgroup    AXTEC CanSat board based on STM32 Nucleo-F303RE
 * @ingroup     boards_common_nucleo64
 * @brief       Support for the AXTEC CanSat board based on STM32 Nucleo-F303RE
 * @{
 *
 * @file
 * @brief       Peripheral MCU configuration for the AXTEC CanSat board based on the nucleo-f303re board
 *
