...
#define THREAD_PRIORITY_I2C         (THREAD_PRIORITY_IDLE - 2)
#define THREAD_PRIORITY_GPS         (THREAD_PRIORITY_IDLE - 3)
#define THREAD_PRIORITY_RF          (THREAD_PRIORITY_IDLE - 13
#define THREAD_PRIORITY_ADC         (THREAD_PRIORITY_IDLE - 14)
#define THREAD_PRIORITY_EMERGENCY   (THREAD_PRIORITY_IDLE - 15)
